...
import com.miempresa.protask.model.TaskModel;
...
/**
 * The base model implementation for the Task service. Represents a row in the &quot;ProTask_Task&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TaskModelImpl extends BaseModelImpl<Task> implements TaskModel {
	 ...
	 */
	public static final String TABLE_NAME = "ProTask_Task";
	...
	public static final String TABLE_SQL_CREATE =
		"create table ProTask_Task (uuid_ VARCHAR(75) null,taskId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null,description VARCHAR(75) null,dueDate DATE null,status INTEGER)";

	public static final String TABLE_SQL_DROP = "drop table ProTask_Task";

	public static final String ORDER_BY_JPQL = " ORDER BY task.dueDate ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY ProTask_Task.dueDate ASC";
	 ...
	 */
	@Deprecated
	public static final long DUEDATE_COLUMN_BITMASK = 8L;
	...
	public int compareTo(Task task) {
		...
		value = DateUtil.compareTo(getDueDate(), task.getDueDate());
