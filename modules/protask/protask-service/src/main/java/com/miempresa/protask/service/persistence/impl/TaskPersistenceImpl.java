...
package com.miempresa.protask.service.persistence.impl;
...
import com.miempresa.protask.model.TaskTable;
import com.miempresa.protask.model.impl.TaskImpl;
import com.miempresa.protask.model.impl.TaskModelImpl;
...
import com.miempresa.protask.service.persistence.impl.constants.ProTaskPersistenceConstants;
...
public class TaskPersistenceImpl
	...
	@Override
	@Reference(
		target = ProTaskPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = ProTaskPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
